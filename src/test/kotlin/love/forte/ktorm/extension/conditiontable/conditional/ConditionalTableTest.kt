package love.forte.ktorm.extension.conditiontable.conditional

import love.forte.ktorm.extension.conditiontable.*
...
class ConditionalTableTest : BaseTest() {
    ...
    fun testCondition1() {
        ...
        database.departmentsWithCondition.filterBy(entity).forEach {
                assert(it.name.startsWith(entity.name))
                assert(it.mixedCase != null)
            }
        
        database.from(DepartmentsWithCondition).select().whereBy(DepartmentsWithCondition, entity).forEach {
    ...
    fun testCondition3() {
        ...
        database.employeesWithCondition.filterBy(entity).forEach {
                assert(it.manager?.id == entityManagerId)
            }
        
        database.from(EmployeesWithCondition).select().whereBy(EmployeesWithCondition, entity).forEach {
    ...
    fun testConditionAndThen1() {
        ...
        database.departmentsWithCondition.filterBy(entity) { table, condition ->
        ...
        database.from(DepartmentsWithCondition).select().whereBy(DepartmentsWithCondition, entity) {
    ...
    fun testConditionAndThen2() {
        ...
        database.departmentsWithCondition.filterByOr(entity) { table, condition ->
        ...
        database.from(DepartmentsWithCondition).select().whereByOr(DepartmentsWithCondition, entity) {
